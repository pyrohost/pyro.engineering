...
<figure>
    <img src="/nexus.png" alt="Pre-release screenshot of a server interface"/>
    <figcaption>Pre-release screenshot of a server interface. Subject to change.</figcaption>
</figure>